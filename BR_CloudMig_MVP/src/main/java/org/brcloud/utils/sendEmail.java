...
public class sendEmail {
	public static void Send() {
		...
		try {
			...
			message.setFrom(new InternetAddress("mukeshotwani.50@gmail.com")); //from
			message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("mukesh.otwani50@gmail.com")); //to
			...
			String filename = "G:\\a.xlsx"; //file to be sent
