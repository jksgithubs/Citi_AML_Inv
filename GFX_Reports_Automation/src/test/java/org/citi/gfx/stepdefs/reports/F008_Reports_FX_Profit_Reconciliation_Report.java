...
public class F008_Reports_FX_Profit_Reconciliation_Report {
	@Given("^Logged into GFX for data val of FX Profit Recon report$")
	public void Logged_into_GFX_for_data_val_of_FX_Profit_Recon_report() throws Throwable {		
		boolean getReports = getReportsReport.contains("RPT_FXProfitReconciliationReport");
		if(!getReports) {
	...
	public void Navigated_to_FX_Profit_Recon_report_for_data_val() throws Throwable {
		MenuSubMenu("mnuMain", "mnuSub");
	}

	@Then("^Validate report data for FX Profit Recon report$")
	public void Validate_report_data_for_FX_Profit_Recon_report() throws Throwable {
	...
	public void Logout_GFX_for_FX_Profit_Recon_report_data_val() throws Throwable {
		Logout();
	}
}