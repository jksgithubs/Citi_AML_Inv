...
public class F004_Reports_Control_Adjustment_Summary_Report {
	@Given("^Logged into GFX for data val of Control Adj Summary report$")
	public void Logged_into_GFX_for_data_val_of_Control_Adj_Summary_report() throws Throwable {		
		boolean getReports = getReportsReport.contains("RPT_ControlAdjustmentSummaryReport");
		if(!getReports) {
	...
	public void Navigated_to_Control_Adj_Summary_report_for_data_val() throws Throwable {
		MenuSubMenu("mnuMain", "mnuSub");
	}

	@Then("^Validate report data for Control Adj Summary report$")
	public void Validate_report_data_for_Control_Adj_Summary_report() throws Throwable {
	...
	public void Logout_GFX_for_Control_Adj_Summary_report_data_val() throws Throwable {
		Logout();
	}
}