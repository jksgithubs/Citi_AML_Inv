...
public class F003_UI_Control_Adjustment_Matching_Report {
	@Given("^Logged into GFX for ui val of Control Adj Matching report$")
	public void Logged_into_GFX_for_ui_val_of_Control_Adj_Matching_report() throws Throwable {		
		boolean getReports = getReportsUI.contains("RPT_ControlAdjustmentMatchingReport");
		if(!getReports) {
	...
	public void Navigated_to_Control_Adj_Matching_report_for_ui_val() throws Throwable {
		MenuSubMenu("mnuMain", "mnuSub");
	}

	@Then("^Validate report ui for Control Adj Matching report$")
	public void Validate_report_ui_for_Control_Adj_Matching_report() throws Throwable {
	...
	public void Logout_GFX_for_Control_Adj_Matching_report_ui_val() throws Throwable {
		Logout();
	}
}