...
public class F002_Logic_Exposure_Report {
	@Given("^Logged into GFX for Exposure Report$")
	public void Logged_into_GFX_for_Exposure_Report() throws Throwable {		
		boolean getReports = getReportsData.contains("RPT_ExposureReport");
		if(!getReports) {
	...
	public void Navigated_to_Exposure_Report() throws Throwable {
		MenuSubMenu("mnuMain", "mnuSub");
	}

	@Then("^Validate data logic with DB for Exposure Report$")
	public void Validate_data_logic_with_DB_for_Exposure_Report() throws Throwable {
	...
	public void Logout_GFX_for_Exposure_Report() throws Throwable {
		Logout();
	}
}