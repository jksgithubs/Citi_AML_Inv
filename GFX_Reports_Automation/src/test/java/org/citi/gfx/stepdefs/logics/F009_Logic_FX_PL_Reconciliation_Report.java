...
public class F009_Logic_FX_PL_Reconciliation_Report {
	@Given("^Logged into GFX for FX PL Reconciliation Report$")
	public void Logged_into_GFX_for_FX_PL_Reconciliation_Report() throws Throwable {		
		boolean getReports = getReportsData.contains("RPT_FXP&LReconciliationReport");
		if(!getReports) {
	...
	public void Navigated_to_FX_PL_Reconciliation_Report() throws Throwable {
		MenuSubMenu("mnuMain", "mnuSub");
	}

	@Then("^Validate data logic with DB for FX PL Reconciliation Report$")
	public void Validate_data_logic_with_DB_for_FX_PL_Reconciliation_Report() throws Throwable {
	...
	public void Logout_GFX_for_FX_PL_Reconciliation_Report() throws Throwable {
		Logout();
	}
}