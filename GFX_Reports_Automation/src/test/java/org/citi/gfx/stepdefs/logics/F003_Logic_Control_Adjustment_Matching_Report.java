...
public class F003_Logic_Control_Adjustment_Matching_Report {
	@Given("^Logged into GFX for Control Adjustment Matching Report$")
	public void Logged_into_GFX_for_Control_Adjustment_Matching_Report() throws Throwable {		
		boolean getReports = getReportsData.contains("RPT_ControlAdjustmentMatchingReport");
		if(!getReports) {
	...
	public void Navigated_to_Control_Adjustment_Matching_Report() throws Throwable {
		MenuSubMenu("mnuMain", "mnuSub");
	}

	@Then("^Validate data logic with DB for Control Adjustment Matching Report$")
	public void Validate_data_logic_with_DB_for_Control_Adjustment_Matching_Report() throws Throwable {
	...
	public void Logout_GFX_for_Control_Adjustment_Matching_Report() throws Throwable {
		Logout();
	}
}