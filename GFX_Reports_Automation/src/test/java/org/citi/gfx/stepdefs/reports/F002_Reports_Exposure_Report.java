...
public class F002_Reports_Exposure_Report {
	@Given("^Logged into GFX for data val of Exposure Report$")
	public void Logged_into_GFX_for_data_val_of_Exposure_Report() throws Throwable {		
		boolean getReports = getReportsReport.contains("RPT_ExposureReport");
		if(!getReports) {
	...
	public void Navigated_to_Exposure_report_for_data_val() throws Throwable {
		MenuSubMenu("mnuMain", "mnuSub");
	}

	@Then("^Validate report data for Exposure report$")
	public void Validate_report_data_for_Exposure_report() throws Throwable {
	...
	public void Logout_GFX_for_Exposure_report_data_val() throws Throwable {
		Logout();
	}
}